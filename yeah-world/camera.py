...
class Camera:
    def __init__(self, training_mode):
        ...
        self.stream = self.camera.capture_continuous(self.capture, format='rgb', use_video_port=True)
        if training_mode:
    ...
    def next_frame(self):
        # By truncating the frame buffer we exchange FPS for lower latency
        # When responding to gestures latency is what matters not, FPS
